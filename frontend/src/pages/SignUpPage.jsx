...
const SignUpPage = () => {
	...
	return (
		<div className="bg-purple-50 h-screen w-screen flex items-center justify-center relative"
			...
			<div className="w-full max-w-xl bg-white rounded-2xl shadow-xl relative z-10 mx-4 sm:mx-auto mt-14 p-8 sm:p-14">

				<h2 className='text-3xl font-bold mb-10 text-center text-purple-600 bg-clip-text'>
					Create Account
				</h2>
				...
				<div className='px-8 py-4 bg-gray-200 bg-opacity-50 flex justify-center mt-6'>
