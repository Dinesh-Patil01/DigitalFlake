...
const Home = () => {
    return (
        <div className="flex-grow p-8 bg-white">
            <div className="bg-gray-100 text-black p-6 rounded-md mx-auto flex flex-col justify-center items-center w-screen h-screen max-w-7xl shadow-lg">
                <img className="w-1/2 md:w-1/4 h-auto" src={logo} alt="Digitalflake Logo" />
                <h2 className="text-2xl font-semibold mt-4 text-center">Welcome to Digitalflake Admin</h2>
            </div>
        </div>
    );
};
